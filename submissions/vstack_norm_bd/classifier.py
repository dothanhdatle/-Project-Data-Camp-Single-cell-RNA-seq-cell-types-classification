...
from sklearn.ensemble import ExtraTreesClassifier, VotingClassifier, StackingClassifier, GradientBoostingClassifier, BaggingClassifier
...
class Classifier(object):
    def __init__(self):
        ...
        estimators_stack = [
            ...
            ('vote', VotingClassifier(estimators=estimators_vote,
             voting='soft')),
