...
from sklearn.ensemble import ExtraTreesClassifier, VotingClassifier, StackingClassifier, GradientBoostingClassifier, RandomForestClassifier
    ...
    def __init__(self):
        ...
        estimators_vote = [
            ...
            ('gb', GradientBoostingClassifier(n_estimators=100,
             learning_rate=0.01, max_features="log2", random_state=42)),
        ]
